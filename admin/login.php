...
<meta charset="utf-8">
<title>登陆</title>
<link type="text/css" rel="stylesheet" href="../public/admin/style/reset.css">
<link type="text/css" rel="stylesheet" href="../public/admin/style/main.css">
<!--[if IE 6]>
<script type="text/javascript" src="../public/js/DD_belatedPNG_0.0.8a-min.js"></script>
<script type="text/javascript" src="../public/js/ie6Fixpng.js"></script>
<![endif]-->
</head>
...
<div class="loginBox">
	...
	<form action="doLogin.php" method="post">
			<ul class="login">
                ...
                <a href="javascript:void(0);" onclick="document.getElementById('verifyImage').src='getVerify.php?r='+Math.random()">看不清，换一个</a>
